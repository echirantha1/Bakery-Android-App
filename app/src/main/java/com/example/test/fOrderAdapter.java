...
public class fOrderAdapter extends FirebaseRecyclerAdapter<AdminAddItemsModel, fOrderAdapter.myViewHolder> {

    public fOrderAdapter(FirebaseRecyclerOptions<AdminAddItemsModel> options)
    {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int i, AdminAddItemsModel model) {
